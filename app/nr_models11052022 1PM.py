...
class AutopartProduct(Document):
    ...
    @classmethod
    def retrieve_all_products(cls, limit=None, skip=None,categories=None,brand=None,models=None,subcategory=None,model=None,search_text=None,model_id=None,brand_id=None):
        all_product = list()
        ...
        if model_id and brand_id:
            print(model_id,brand_id)
            filter=filter & Q(model_id=model_id,brand_id=brand_id)
